...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-slate-800/80 bg-navy-900/90 text-slate-100 shadow-xl backdrop-blur-md transition-all",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-lg md:text-xl font-bold leading-tight tracking-tight text-white",
      className
    )}
    {...props}
  />
